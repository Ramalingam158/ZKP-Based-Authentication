...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3340245017ltr&server=1">
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="712c423760762526572c617c6a572753">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="zkp" targettable="users">
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM `users` WHERE `users`.`s_no` = 8</span>
                        </div>
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM `users` WHERE `users`.`s_no` = 10</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="zkp" targettable="users">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM `users` WHERE `users`.`s_no` = 11</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="zkp" targettable="users">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM `users` WHERE `users`.`s_no` = 15</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="zkp" targettable="users">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM `users` WHERE `users`.`s_no` = 16</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="zkp" targettable="users">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM `users` WHERE `users`.`s_no` = 17</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="zkp" targettable="users">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM `users` WHERE `users`.`s_no` = 20</span>
                        </div>
